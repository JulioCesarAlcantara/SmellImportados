        ...
        <div id ="redor">
            <div class="container">
                ...
                <form class="form-signin" action="promocao" method="post">
                    ...
                    <input type="name" id="inputName" class="form-control" placeholder="Nome " name="nomePromocao"></br>                    
                    <br><input type="text" id="inputDt" class="form-control" placeholder="Data do Início" name="dataInicioPromocao"></br>                    
                    <br><input type="text" id="inputDt" class="form-control" placeholder="Data do Fim" name="dataFimPromocao"></br>
