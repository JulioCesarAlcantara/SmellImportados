...
<html>
    ...
    <body>
        <form class="form-signin" action="produtos" method="post">
                    ...
                    <br><input type="file" id="inputImagem" class="form-control" placeholder="Imagem do Produto " name="imagemProduto1"></br>
                    <br><input type="file" id="inputImagem" class="form-control" placeholder="Imagem do Produto " name="imagemProduto2"></br>
                    <br><input type="file" id="inputImagem" class="form-control" placeholder="Imagem do Produto " name="imagemProduto3"></br>
